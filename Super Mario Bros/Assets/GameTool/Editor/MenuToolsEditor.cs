    ...
    public class MenuToolsEditor
    {
        ...
        public static void Pooling()
        {
            Selection.activeObject =
                AssetDatabase.LoadAssetAtPath<PoolingTable>("Assets/GameTool/Resources/PoolingTable.asset");
        }
        ...
        {
            Selection.activeObject =
                AssetDatabase.LoadAssetAtPath<CanvasPrefTable>("Assets/GameTool/Resources/CanvasPrefTable.asset");
        }
    }
}